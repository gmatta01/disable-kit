# Submitting WP Strip to WordPress.org

Prepared artifacts for directory submission.

## Before you submit

1. Confirm the plugin slug `wp-strip` is available: search https://wordpress.org/plugins/
...
2. Upload `dist/wp-strip-1.0.0.zip`
...
```bash
svn co https://plugins.svn.wordpress.org/wp-strip wp-strip-svn
